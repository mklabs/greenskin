...
$(function () {
  ...
  var JobItemView = Backbone.View.extend({
    ...
    handleClick: function (e) {
      ...
      App.$el.find('#main-pane').toggleClass('selected', selected);
  ...
  var JobListView = Backbone.View.extend({
    ...
    render: _.throttle(function () {
      this.$el.empty().append(this.jobItems.slice(0, 1).map(function (jobItem) {
  ...
  var JobDetailsView = Backbone.View.extend({
    ...
    close: function () {
      App.$el.find('#main-pane').toggleClass('selected', false);
